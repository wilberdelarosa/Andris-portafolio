...
La entrada no interpone una cortina antes del contenido. La portada aparece con una animación breve de transform y opacidad; las transiciones de ruta duran 180 ms. El proyecto destacado cambia de inmediato y suaviza su aparición en 160 ms, sin esperar una animación de salida. Los mapas compactos montan su código al acercarse al viewport; el visor 360 solo se carga al abrirlo. El catálogo público obtiene los detalles en una sola petición. Los enlaces de la exportación estática mantienen la precarga de Next desactivada porque sus rutas de datos prefetched devolvieron 404 en la verificación local.

Mediciones y comprobaciones de esta iteración: [PERFORMANCE-QA-2026-09-25.md](PERFORMANCE-QA-2026-09-25.md).
