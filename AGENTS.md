...
This project is indexed by GitNexus as **AndrisPortafolio** (5015 symbols, 8756 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
