...
This project is indexed by GitNexus as **AndrisPortafolio** (1995 symbols, 3072 relationships, 92 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
