...
This project is indexed by GitNexus as **AndrisPortafolio** (1180 symbols, 1611 relationships, 15 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
