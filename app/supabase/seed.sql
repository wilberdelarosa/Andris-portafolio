...
('success', 'Sistema listo para producci�n', 'Todos los proyectos y configuraciones han sido validados. El sistema de notificaciones est� activo y conectado a la base de datos.'),
('info', 'Migraci�n completada', 'El proyecto ya no depende de datos est�ticos de prueba. Puedes agregar y eliminar proyectos usando el gestor.');
