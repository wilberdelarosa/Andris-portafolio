...
export const catalogCopy = {
  es: {
    ...
    compareSubtitle: "Contrasta arquitectura, planes de pago, beneficios fiscales y tiempos de entrega.",
    ...
    verifiedStatus: "Datos confirmados",
    pendingStatus: "Por confirmar con desarrollador",
  },
  en: {
    eyebrow: "Catalogue",
    ...
    compareSubtitle: "Contrast architecture, payment plans, tax incentives, and delivery timelines.",
    ...
    verifiedStatus: "Confirmed details",
    pendingStatus: "To be confirmed with developer",
  },
  fr: {
    eyebrow: "Catalogue",
    ...
    confirmedPrice: "Prix confirmé",
    pendingPrice: "Prix à confirmer",
    ...
    compareSubtitle: "Comparez l'architecture, les conditions de paiement, les avantages fiscaux et les délais de livraison.",
    ...
    verifiedStatus: "Données confirmées",
    pendingStatus: "À confirmer avec le promoteur",
  },
} as const;
